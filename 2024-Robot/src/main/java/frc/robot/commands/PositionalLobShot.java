...
public class PositionalLobShot extends Command {
  ...
  private double shooterDegreesAllowedError = 2.0;
  private double shooterRPMAllowedError = 300;
  ...
  public void initialize() {
    ...
    this.shooterValues = Constants.SetPoints.getLobValuesFromDistance(this.speakerElevationDegrees);
  ...
  public void execute() {
    ...
    this.shooterValues = Constants.SetPoints.getLobValuesFromDistance(this.distToSpeakerMeters);
    this.shooterDegrees = this.shooterValues[0];
