...
public class LobShot extends Command {
  ...
  public void execute() {
    ...
    this.shooter.setShooterRPM(this.shooterRPM, this.shooterRPM);
    this.shooter.setShooterAngle(this.shooterDegrees);

    if (Math.abs(this.shooter.getShooterAngle() - this.shooterDegrees) <= this.shooterDegreesAllowedError && Math.abs(this.shooter.getLeftShooterRPM() - this.shooterRPM) <= this.shooterRPMAllowedError && Math.abs(Constants.SetPoints.standardizeAngleDegrees(pigeonAngleDegrees) - this.targetPigeonAngleDegrees) <= this.driveAngleAllowedError){
